...
<br><br><br><br>
    ...
    <div align="center">
        <h2>Global de reportes emitidos en el sistema</h2>

        <div>
            <label for="areaReportes">Área de reportes</label>
            <select name="areaReportes">
                <option value="" selected disabled hidden>Área de reportes</option>
